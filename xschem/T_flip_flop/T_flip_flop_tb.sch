...
C {devices/vsource.sym} 310 -260 0 1 {name=V2 value="DC 0 PWL(0 0 \{(2/f)+1/(2*f)\} 0 \{(2/f)+1/(2*f)+0.1u\} 1.2 \{(2/f)+4/(2*f)\} 1.2 \{(2/f)+4/(2*f)+0.1u\} 0)"}
...
.save all
"}
C {devices/vsource.sym} 450 -70 0 0 {name=V3 value="DC 0 PULSE(0 1.2 \{2/f\} 1n 1n \{duty_cycle*1/f\} \{1/f\})"}
