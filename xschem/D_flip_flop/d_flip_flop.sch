...
T {CLK_inv is the inverted Clk
D is the input} -100 -310 0 0 0.4 0.4 {}
...
N -230 -60 10 -60 { lab=Clk_inv}
N 10 -70 10 -60 { lab=Clk_inv}
N -130 -60 -130 -40 { lab=Clk_inv}
N -260 -210 -260 -60 { lab=Clk_inv}
N -260 -210 370 -210 { lab=Clk_inv}
N 370 -210 370 -190 { lab=Clk_inv}
N -260 -60 -260 100 { lab=Clk_inv}
N -260 100 270 100 { lab=Clk_inv}
N 270 80 270 100 { lab=Clk_inv}
...
C {devices/lab_pin.sym} -260 -60 2 0 {name=l5 sig_type=std_logic lab=Clk_inv}
