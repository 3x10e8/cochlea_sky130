...
N -150 90 -150 110 { lab=Clk_inv}
N -150 -10 -150 10 { lab=Clk}
N -10 -60 -10 -40 { lab=Clk}
N -10 -150 -10 -140 { lab=Clk_inv}
N 250 90 250 110 { lab=Clk}
N 250 0 250 10 { lab=Clk_inv}
N 250 -10 250 0 { lab=Clk_inv}
N -10 -160 -10 -150 { lab=Clk_inv}
N 350 -60 350 -40 { lab=Clk_inv}
N 350 -160 350 -140 { lab=Clk}
N -280 -30 -250 -30 { lab=Clk}
N -650 -30 -440 -30 { lab=Clk}
N -410 -160 -10 -160 { lab=Clk_inv}
N -10 -160 240 -160 { lab=Clk_inv}
N 270 -40 350 -40 { lab=Clk_inv}
N 240 -160 250 -160 { lab=Clk_inv}
N 250 -160 250 -10 { lab=Clk_inv}
N 250 -40 270 -40 { lab=Clk_inv}
...
N -510 -160 -510 110 { lab=Clk_inv}
N -350 110 -150 110 { lab=Clk_inv}
N -440 -180 -280 -180 { lab=Clk}
N -510 -160 -410 -160 { lab=Clk_inv}
N -510 110 -350 110 { lab=Clk_inv}
N -440 130 -280 130 { lab=Clk}
N -440 -30 -280 -30 { lab=Clk}
N -220 50 -200 50 { lab=#net6}
N -390 70 -360 70 { lab=D}
N -560 70 -390 70 { lab=D}
N -690 70 -560 70 { lab=D}
N -690 40 -630 40 { lab=RST}
N -530 40 -360 40 { lab=#net7}
N -570 -160 -510 -160 { lab=Clk_inv}
...
C {devices/lab_pin.sym} -510 -160 2 0 {name=l5 sig_type=std_logic lab=Clk_inv}
