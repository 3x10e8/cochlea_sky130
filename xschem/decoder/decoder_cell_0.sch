...
N 1020 200 1020 400 { lab=v1_bar}
N 1100 200 1100 400 { lab=v1}
...
C {devices/iopin.sym} 970 220 2 0 {name=p2 lab=Vdd}
C {devices/ipin.sym} 1100 390 3 0 {name=p3 lab=in}
C {devices/ipin.sym} 1020 390 3 0 {name=p4 lab=in_bar}
C {devices/opin.sym} 1020 210 3 0 {name=p5 lab=v1_bar}
C {devices/opin.sym} 1100 210 3 0 {name=p6 lab=v1}
C {devices/iopin.sym} 1130 300 0 0 {name=p10 lab=out}
C {devices/iopin.sym} 970 380 0 1 {name=p7 lab=h1}
C {devices/iopin.sym} 970 300 0 1 {name=p8 lab=out}
