...
N 110 -30 160 -30 { lab=opi}
N 110 -10 160 -10 { lab=omi}
N 110 10 160 10 { lab=opq}
N 110 30 160 30 { lab=omq}
...
C {devices/lab_pin.sym} 160 -30 2 0 {name=l1 sig_type=std_logic lab=opi}
...
C {devices/lab_pin.sym} 160 -10 2 0 {name=l2 sig_type=std_logic lab=omi}
C {devices/lab_pin.sym} 160 10 2 0 {name=l9 sig_type=std_logic lab=opq}
C {devices/lab_pin.sym} 160 30 2 0 {name=l14 sig_type=std_logic lab=omq}
...
C {wavelet_channel/wavelet_iq.sym} 40 0 0 0 {name=X1 W=20 L=20}
C {clkgen/filter_clkgen.sym} 230 310 0 0 {name=X2}
