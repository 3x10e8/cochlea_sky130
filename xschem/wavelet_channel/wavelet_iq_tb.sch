...
N -340 120 -50 120 { lab=#net1}
N -50 70 -50 120 { lab=#net1}
N -300 200 -20 200 { lab=#net2}
N -20 70 -20 200 { lab=#net2}
N 140 40 140 60 { lab=thresh}
N 110 40 140 40 { lab=thresh}
N -240 280 20 280 { lab=#net3}
N 20 70 20 280 { lab=#net3}
N -190 360 50 360 { lab=#net4}
N 50 70 50 360 { lab=#net4}
N 80 70 80 440 { lab=#net5}
N -140 440 80 440 { lab=#net5}
...
C {devices/vsource.sym} -190 390 0 0 {name=Vphi2 value="DC 0 PULSE (0 1.2 1n 1n 1n \{phi_dc*1/fphi\} \{1/fphi\} 120"
*SIN (0.6 0.6 1k)"}
C {devices/gnd.sym} -190 420 0 0 {name=l33 lab=GND}
C {devices/gnd.sym} -340 -120 0 0 {name=l38 lab=GND}
C {wavelet_channel/wavelet_iq.sym} 0 0 0 0 {name=X1 W=20 L=20}
C {devices/vsource.sym} 140 90 0 0 {name=Vthresh value="DC 0 PWL (0 0 \{tau\} 0 \{3*tau\} 0 \{4*tau\} 1)"
*SIN (0.6 0.6 1k)"}
C {devices/gnd.sym} 140 120 0 0 {name=l6 lab=GND}
C {devices/lab_pin.sym} 140 40 2 0 {name=l10 sig_type=std_logic lab=thresh}
C {devices/vsource.sym} -140 470 0 0 {name=Vphi3 value="DC 0 PULSE (0 1.2 1n 1n 1n \{phi_dc*1/fphi\} \{1/fphi\} 240"
*SIN (0.6 0.6 1k)"}
