...
C {Switched_Caps/16switchcaps_2phi.sym} 350 -230 0 0 {name=X3 W=W L=L}
C {devices/lab_pin.sym} 570 -280 1 0 {name=l18 sig_type=std_logic lab=phi2_clkb}
C {Switched_Caps/16switchcaps_2phi.sym} 350 -110 0 0 {name=X4 W=W L=L}
C {Switched_Caps/16switchcaps_2phi.sym} 350 10 0 0 {name=X5 W=W L=L}
C {devices/lab_pin.sym} 160 180 3 0 {name=l27 sig_type=std_logic lab=phi1_clk}
C {Switched_Caps/16switchcaps_2phi.sym} 350 130 0 0 {name=X6 W=W L=L}
